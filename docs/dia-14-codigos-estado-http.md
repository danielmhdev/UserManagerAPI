...
- **La clave:** El problema está en _cómo se envían los datos_.
...
- **La clave:** El cliente pregunta por algo específico que _no se puede localizar_.
- **Ejemplo en UserManager API:**
...
- **La clave:** Los datos son válidos por sí solos, pero _chocan contra la base de datos_.
- **Ejemplo en UserManager API:**
...
- **Respuesta típica del cliente:** Redirigir al usuario a la pantalla de _Login_.
...
- **La clave:** El servidor sabe quién eres, pero te dice: _"Lo siento, no tienes permiso para tocar esto"_.
- **Ejemplo en el futuro de la API:**
...
- **Respuesta típica del cliente:** Mostrar un mensaje tipo _"No tienes permisos suficientes para realizar esta acción"_.
...
| -------------------- | ----------------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| **401 Unauthorized** | Autenticación           | _"¿Quién eres? Enséñame tu credencial."_                  | No te dejan entrar al edificio porque no llevas acreditación.                                                         |
| **403 Forbidden**    | Autorización / Permisos | _"Sé quién eres, pero ¿tienes permiso para entrar aquí?"_ | Entras al edificio con tu acreditación, pero intentas pasar a la sala de servidores donde solo entra el equipo de IT. |
