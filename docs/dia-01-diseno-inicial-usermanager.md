...
Una API (_Application Programming Interface_) es un "puente" que conecta dos mundos para que una aplicación funcione, es decir el backend con el frontend. Normalmente en formato JSON.
